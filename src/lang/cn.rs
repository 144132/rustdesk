...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Edit device group", "编辑设备分组"),
        ("Unassign device group", "取消设备分组"),
        ("Select device group", "选择设备分组"),
        ("No device groups available", "暂无可用的设备分组"),
        ("Device group update failed", "编辑设备分组失败"),
        ("No permission to edit device group", "没有编辑设备分组的权限"),
        ("Group", "小组"),
        ("Search", "搜索"),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unassign device group", "Unassign device group"),
        ("Select device group", "Select device group"),
        ("No device groups available", "No device groups available"),
        ("Device group update failed", "Failed to update device group"),
        ("No permission to edit device group", "You don't have permission to edit device groups"),
